        ...
        if (storedApps && storedStatuses) {
            ...
            loadedBookings = loadedBookings.map((booking) => {
                const matchingApp = apps.find(
                    (a) => a.hirerId === booking.hirerId && a.venueId === booking.venueId && a.eventName === booking.eventName
                );
                ...
                <Box flex="1" p={6}>
                    ...
                    <Flex gap={4} mb={6}>
                        ...
                        >
                            ...
                            <Text fontSize="2xl" fontWeight="bold">{savedVenuesCount}</Text>
                        ...
                        >
                            ...
                            <Text fontSize="2xl" fontWeight="bold">{totalRatingsCount}</Text>
                        </Box>
                    </Flex>
